...
module "environment" {
  ...
  target_environment_description     = "DaVinci DaVinci SSO Protect Sample App integration environment provisioned with Terraform. By PingIdentity, Technical Enablement."
