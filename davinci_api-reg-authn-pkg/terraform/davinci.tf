...
// Flow Name: PingOne DaVinci API Registration Example
resource "davinci_flow" "pingone_davinci_api_registration_example" {
...
resource "davinci_application_flow_policy" "registration_flow_app_policy" {
  ...
  policy_flow {
    flow_id    = davinci_flow.pingone_davinci_api_registration_example.id
    version_id = -1
    weight     = 100
  }
}
