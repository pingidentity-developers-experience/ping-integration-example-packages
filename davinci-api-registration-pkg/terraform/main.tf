...
module "environment" {
  ...
  target_environment_description     = "DaVinci API Registration Sample App integration environment provisioned with Terraform. By PingIdentity, Technical Enablement."
